---
title: "rabc tutorial \n - a package facilitating accelerometer analysis with visual
  tools"
output:
...
```{r cache=TRUE, warning=FALSE, fig.align='center', out.width="100%", fig.cap="Figure 4. The accuracy plot of selected features. Red line and dots in the plot denotes classification accuracies of accumulated selected features. Grey bars indicate accuracy increase (labeled with numbers) of each selected feature."}
